                                ...
                                <div className="flex flex-col justify-center max-w-3xl mx-auto space-y-6">
                                    <div className="space-y-2">
                                        ...
                                        <p className="max-w-[600px] text-muted-foreground md:text-xl">
                                            ...
                                            people with disabilities from using
                        ...
                        <div className="container px-4 pt-48 mx-auto md:px-6 max-w-7xl">
                            <div className="flex flex-col items-center justify-center space-y-4 text-center">
                                <div className="space-y-2">
                                    ...
                                    <p className="max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                                        Our accessibility checker helps ensure
                                        your website works for people with
                            ...
                            <div className="grid max-w-6xl grid-cols-1 gap-6 py-12 mx-auto md:grid-cols-2 lg:grid-cols-3">
                                <Card>
                                    ...
                                    <CardContent>
                                        <CardDescription className="text-sm text-muted-foreground">
                                            ...
                                            reader compatibility to support
                                ...
                                <Card>
                                    ...
                                    <CardContent>
                                        <CardDescription className="text-sm text-muted-foreground">
                                            We ensure audio content has captions
                                            or transcripts, and that visual cues
                                ...
                                <Card>
                                    ...
                                    <CardContent>
                                        <CardDescription className="text-sm text-muted-foreground">
                                            ...
                                            adequate target sizes, and proper
                                            focus management for users with
                                ...
                                <Card>
                                    ...
                                    <CardContent>
                                        <CardDescription className="text-sm text-muted-foreground">
                                            ...
                                            consistent layouts, and readable
                                            content for users with cognitive or
                                ...
                                <Card>
                                    ...
                                    <CardContent>
                                        <CardDescription className="text-sm text-muted-foreground">
                                            We identify flashing content that
                                            could trigger seizures and ensure
                                ...
                                <Card>
                                    ...
                                    <CardContent>
                                        <CardDescription className="text-sm text-muted-foreground">
                                            We ensure your site works for
                                            everyone, including those with
                                            temporary impairments like broken
                                            arms or situational limitations.
                                        </CardDescription>
                                    </CardContent>
                                </Card>
                            </div>
                        ...
                        <div className="container px-4 mx-auto md:px-6 max-w-7xl">
                            <div className="flex flex-col items-center justify-center space-y-4 text-center">
                                <div className="space-y-2">
                                    ...
                                    <p className="max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                                        Our accessibility scanner provides
                                        detailed insights to help make your
                                        website usable by people with
                                        disabilities.
                                    </p>
                                </div>
                            </div>
                                ...
                                <Card>
                                    ...
                                    <CardContent>
                                        <CardDescription className="text-sm text-muted-foreground">
                                            ...
                                            on how to fix each accessibility
                                            issue, making your site more
                                            inclusive for people with
                                            disabilities.
                                        </CardDescription>
                                    </CardContent>
                                </Card>
                                <Card>
                                    ...
                                    <CardContent>
                                        <CardDescription className="text-sm text-muted-foreground">
                                            ...
                                            severity levels, helping you address
                                            the most critical barriers first.
                                        </CardDescription>
                                    </CardContent>
                                </Card>
                            </div>
                            ...
                            <div className="grid max-w-6xl gap-10 mx-auto lg:grid-cols-2">
                                <div className="space-y-4 text-center lg:text-left">
                                    ...
                                    <p className="text-muted-foreground md:text-xl">
                                        Our scanner evaluates your website
                                        against established accessibility
                                        standards that ensure people with
                                        disabilities can use your site.
                                    </p>
                                    <ul className="grid gap-4">
                                        <li className="flex items-center gap-2">
                                            <Check className="w-5 h-5 text-primary" />
                                            <span>
                                                WCAG 2.1 A, AA, and AAA
                            ...
                            <div className="flex flex-col items-center justify-center space-y-4 text-center">
                                <div className="space-y-2">
                                    ...
                                    <p className="max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                                        ...
                                        accessibility report and take the first
                                        step toward an inclusive web presence.
                                    </p>
                                </div>
                                <div className="w-full max-w-md mx-auto space-y-4">
                                    ...
                                    >
                                        <div className="flex-1">
                                            {showAuthNotification &&
                                                !auth.user && (
                                                    <div className="p-3 mb-2 text-sm rounded-md shadow-lg text-primary-foreground bg-primary animate-in fade-in-0 slide-in-from-top-1">
                                                        Please sign in to use
                                                        the accessibility
                                                        checker
                                                    </div>
                    ...
                    <footer className="w-full py-6 border-t md:py-8">
                        <div className="container flex items-center justify-around gap-4 text-center md:flex-row md:gap-8">
                            ...
                            <p className="text-sm text-center text-muted-foreground md:text-left">
                                ...
                                AccessibilityChecker. Created by Gavin, Mathew,
                                Anna, and Megan
                            </p>
                        </div>
                    </footer>
